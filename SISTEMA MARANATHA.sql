...
CREATE TABLE PAGOS(
	...
	CONSTRAINT RELACIONAR_VENTAS_P FOREIGN KEY (IDVENTA) REFERENCES VENTA(IDVENTA),
	CONSTRAINT RELACIONAR_CLIENTES_P FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTE(IDCLIENTE),
	CONSTRAINT RELACIONAR_GARANTE_P FOREIGN KEY (IDGARANTE) REFERENCES GARANTE(IDGARANTE)
)
...
CREATE TABLE CREDITO (
	...
	-- REFERENCIAR O RELACIONAR
	CONSTRAINT RELACIONAR_PAGOS FOREIGN KEY (IDPAGOS) REFERENCES PAGOS(IDPAGOS)
)
...
CREATE TABLE COMPRA(
	...
	IDUSUARIO INT NOT NULL,
	-- REFERENCIAR O RELACIONAR
	CONSTRAINT RELACIONAR_USUARIOC FOREIGN KEY (IDUSUARIO) REFERENCES USUARIO(IDUSUARIO)
)
...
CREATE TABLE PAGOFACTURA(
	...
	-- REFERENCIAR O RELACIONAR
	CONSTRAINT RELACIONAR_CLIENTEPF FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTE(IDCLIENTE),
	CONSTRAINT RELACIONAR_USUARIOPF FOREIGN KEY (IDUSUARIO) REFERENCES USUARIO(IDUSUARIO),
)
